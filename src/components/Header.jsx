...
const Header = ()=>{
    return (
        <>
         {/* HEADER TOP STRIP */}
         <header className="header-top-strip  text-white py-2">
            <div className="container-xxl  ">
                <div className="row">
                    ...
                    <div className="col-6">
                    <p className="mb-0">
                            Hotline: <a href="tel: +92 313 0159250"> 
                            +92 313 0159250
                        </a>
                        </p>
                    </div>
                ...
                <div className="row align-items-center ">
                    ...
                    <div className="col-5 pr-4 ">
                        <div className="input-group">
                            <input class="form-control" type="text" placeholder="Search Products Here..." aria-label="Search Products Here..."  />
                    ...
                    <div className="col-5  icons">
                        <div className="header-upper-links d-flex align-items-center justify-content-between">
                            ...
                            <div className="d-flex align-items-center justify-content-between ms-4  ">
                                <i class="fa-solid fa-cart-shopping icon-size-cart"></i>
                    ...
                    <div className="col-12 d-flex align-items-center gap-30">
                        <div className="menu-bottom d-flex align-items-center  ">
                            <div className="dropdown ">
                                <button className="btn d-flex justify-content-between align-items-center gap-15 btn-secondary dropdown-toggle bg-transparent border-0" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                     
                            <CgMenuGridO className="text-white fs-5 mx-2" />Show Categories
                                </button>
                                <ul className="dropdown-menu " aria-labelledby="dropdownMenuButton1">
                                    <li><NavLink to='/'>Home</NavLink></li>
                                    <li><NavLink to='/'>Our Store</NavLink></li>
